...
class myuploadfile(models.Model):
    id_GPPD=models.CharField(max_length=30 , null = False, blank=False, default=True)
...
class GPPDOption(models.Model):
    ...
    ID                                  = models.CharField(max_length=30,default="DNP_2020_2021_v1" , null = False, blank=False)
